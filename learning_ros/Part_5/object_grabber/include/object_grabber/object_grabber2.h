...
//v2:adds functionality to straddle an object and plan cartesian move to specified goal
...
private:
    ...
    geometry_msgs::PoseStamped goal_pose_stamped_;    
...
//int32 SET_SPEED_FACTOR = 10    #use arg speed_factor to change time scale of trajectory plan; larger than 1.0--> slower
    ...
    int  straddle_object(int object_id,geometry_msgs::PoseStamped object_pose_stamped);
