...
bool ObjectFinder::find_toy_block(float surface_height, geometry_msgs::PoseStamped &object_pose) {
    ...
    ROS_INFO("BETA: surface height is %f - plane_normal is %f - plane dist is %f - major axis is %f - and centroid is %f.", 
			surface_height, plane_normal(0), plane_dist, major_axis(0), centroid(0));
